    ...
    implements Runnable
{
                ...
                if(Keyboard.getEventKeyState())
                {
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                            ...
                            {
                                displayGuiScreen(new GuiInventoryMoreSlots(thePlayer));
                            }
    ...
    public void usePortal(int i)
    {
        ...
        if(thePlayer.dimension == 3){
              ...
              World world1 = null;
              world1 = new World(theWorld, WorldProvider.getProviderForDimension(3));
              changeWorld(world1, "Entering the fucking aether", thePlayer);
        }
