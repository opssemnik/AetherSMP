...
//            Render, RenderBlocks, Block, EntityFloatingBlock, 
//            MathHelper, Tessellator, World, Entity
...
public class RenderFloatingBlock extends Render
{
    ...
    public void doRenderFallingSand(EntityFloatingBlock entityfloatingblock, double d, double d1, double d2, 
            float f, float f1)
    {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        doRenderFallingSand((EntityFloatingBlock)entity, d, d1, d2, f, f1);
    }
