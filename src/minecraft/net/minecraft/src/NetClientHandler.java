...
//            Block, ModLoaderMp, NetClientHandlerEntity, World, 
//            ModLoader, EntityLiving, Packet71Weather, EntityLightningBolt, 
...
//            Packet4UpdateTime, ChunkCoordinates, Packet6SpawnPosition, WorldInfo, 
//            Packet39AttachEntity, Packet38EntityStatus, Packet8UpdateHealth, Packet9Respawn, 
//            Explosion, Packet60Explosion, Packet100OpenWindow, InventoryBasic, 
//            Container, TileEntityFurnace, TileEntityDispenser, MathHelper, 
//            Packet103SetSlot, Slot, Packet106Transaction, Packet104WindowItems, 
//            Packet130UpdateSign, TileEntitySign, TileEntity, Packet105UpdateProgressbar, 
        ...
        if(netclienthandlerentity != null)
        {
            try
            {
                ...
                if(netclienthandlerentity.entityHasOwner)
                {
                    ...
                    {
                        Entity entity1 = getEntityByID(packet23vehiclespawn.field_28044_i);
                        if(entity1 == null)
                        {
