...
public class BlockFreezer extends BlockContainer
{
    ...
    protected BlockFreezer(int i)
    {
        super(i, Material.rock);
        blockIndexInTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/FreezerTop.png");
        sideTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/FreezerSide.png");
