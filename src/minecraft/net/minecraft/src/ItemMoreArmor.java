...
public class ItemMoreArmor extends Item
{
    ...
    public ItemMoreArmor(int i, int j, int k, int l, int i1)
    {
        super(i);
        armorLevel = j;
        armorType = l;
    ...
    public ItemMoreArmor(int i, int j, String s, int k)
    {
        this(i, j, 0, k);
        texture = s;
    }

    public ItemMoreArmor(int i, int j, String s, int k, int l)
    {
        this(i, j, 0, k, l);
        texture = s;
    }

    public ItemMoreArmor(int i, int j, String s, int k, int l, boolean flag)
    {
        this(i, j, s, k, l);
