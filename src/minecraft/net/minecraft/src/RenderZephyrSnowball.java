...
public class RenderZephyrSnowball extends Render
{
    ...
    public void func_4012_a(EntityZephyrSnowball entityzephyrsnowball, double d, double d1, double d2, 
            float f, float f1)
    {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        func_4012_a((EntityZephyrSnowball)entity, d, d1, d2, f, f1);
    }
}
