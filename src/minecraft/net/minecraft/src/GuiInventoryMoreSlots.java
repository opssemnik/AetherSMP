...
//            GuiContainer, EntityPlayer, AchievementList, RenderEngine, 
//            EntityPlayerSP, RenderHelper, RenderManager, GuiButton, 
...
public class GuiInventoryMoreSlots extends GuiContainer
{
    ...
    {
        int i = mc.renderEngine.getTexture("/aether/gui/inventory.png");
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(j + 33, k + 75, 50F);
        float f1 = 30F;
