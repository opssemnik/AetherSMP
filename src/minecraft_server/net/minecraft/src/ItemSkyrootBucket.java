...
public class ItemSkyrootBucket extends Item
{
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        if(itemstack.getItemDamage() == 0 && movingobjectposition != null && movingobjectposition.entityHit != null && ((movingobjectposition.entityHit instanceof EntityCow) || (movingobjectposition.entityHit instanceof EntityFlyingCow)))
        {
