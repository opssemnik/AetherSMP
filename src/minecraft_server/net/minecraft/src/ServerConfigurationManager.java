...
public class ServerConfigurationManager
{
    ...
    public ServerConfigurationManager(MinecraftServer minecraftserver)
    {
        ...
        playerManagerObj[2] = new PlayerManager(minecraftserver, 3, i);
    ...
    {
        return i != -1 ? playerManagerObj[0] : (i == 3 ? playerManagerObj[2] : playerManagerObj[1]);
    }
    ...
    public void playerLoggedIn(EntityPlayerMP entityplayermp)
    {
        ...
        WorldServer worldserver = mcServer.getWorldManager(3);
        worldserver.chunkProviderServer.loadChunk((int)entityplayermp.posX >> 4, (int)entityplayermp.posZ >> 4);
