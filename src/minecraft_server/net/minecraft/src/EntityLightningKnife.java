...
//            World, Vec3D, MovingObjectPosition, EntityLightningBolt, 
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
                ...
                int i1 = MathHelper.floor_double(movingobjectposition.entityHit.boundingBox.minY);
                int k1 = MathHelper.floor_double(movingobjectposition.entityHit.boundingBox.minZ);
                EntityLightningBolt entitylightningbolt = new EntityLightningBolt(worldObj, j, i1, k1);
                entitylightningbolt.setLocationAndAngles(j, i1, k1, rotationYaw, 0.0F);
            ...
            } else
            {
                ...
                EntityLightningBolt entitylightningbolt1 = new EntityLightningBolt(worldObj, posX, posY, posZ);
                entitylightningbolt1.setLocationAndAngles(k, j1, l1, rotationYaw, 0.0F);
                worldObj.entityJoinedWorld(entitylightningbolt1);
            }
            for(int l = 0; l < 8; l++)
            {
