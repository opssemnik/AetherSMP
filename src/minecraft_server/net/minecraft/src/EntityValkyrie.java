    ...
    implements IAetherBoss
{
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        if(!duel)
        {
            ...
            if(itemstack1 != null && itemstack1.itemID == AetherItems.VictoryMedal.shiftedIndex && itemstack1.stackSize >= 10)
            {
                ...
                {
                    itemstack1.func_577_a(entityplayer);
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return worldObj.getBlockLightValue(i, j, k) > 8 && worldObj.checkIfAABBIsClear(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).size() == 0 && !worldObj.getIsAnyLiquid(boundingBox);
    }
    ...
    private void unlockTreasure()
    {
        ...
        //(AetherAchievements.defeatSilver);
