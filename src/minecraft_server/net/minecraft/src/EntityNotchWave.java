...
//            Vec3D, World, MovingObjectPosition, NBTTagCompound, 
...
public class EntityNotchWave extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null && movingobjectposition.entityHit != thrower && movingobjectposition.entityHit != slider)
            {
                if(movingobjectposition.entityHit.attackEntityFrom(thrower, 0));
                movingobjectposition.entityHit.motionX += motionX;
                movingobjectposition.entityHit.motionY += 0.59999999999999998D;
                movingobjectposition.entityHit.motionZ += motionZ;
            }
            for(int i = 0; i < 8; i++)
            {
                worldObj.spawnParticle("explode", posX, posY, posZ, 0.0D, 0.0D, 0.0D);
                worldObj.spawnParticle("explode", posX, posY, posZ, 0.0D, 0.0D, 0.0D);
