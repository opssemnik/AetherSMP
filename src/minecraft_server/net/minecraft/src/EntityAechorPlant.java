...
public class EntityAechorPlant extends EntityAetherAnimal
{
    ...
    {
        dropItem(AetherItems.AechorPetal.shiftedIndex, 2 * ((this.playerToAttack != null && ((EntityPlayer)this.playerToAttack).inventory.getStackInSlot(0).itemID == AetherItems.SwordSkyroot.shiftedIndex ? 2 : 1)));
    }
