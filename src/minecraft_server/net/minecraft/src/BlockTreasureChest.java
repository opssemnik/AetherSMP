...
//            World, TileEntityChest, GuiTreasureChest, EntityPlayer, 
//            ModLoader, InventoryPlayer, ItemStack, AetherItems, 
//            Item, TileEntity
...
public class BlockTreasureChest extends BlockContainer
{
    ...
    public boolean blockActivated(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
        ...
        if(itemstack != null && itemstack.itemID == AetherItems.Key.shiftedIndex && itemstack.getItemDamage() == 0 && l == 0)
        {
        ...
        if(itemstack != null && itemstack.itemID == AetherItems.Key.shiftedIndex && itemstack.getItemDamage() == 1 && l == 2)
        {
            entityplayer.inventory.decrStackSize(entityplayer.inventory.currentItem, 1);
            world.setBlockMetadata(i, j, k, l + 1);
            world.setBlockTileEntity(i, j, k, tileentitychest);
        ...
        if(itemstack != null && itemstack.itemID == AetherItems.Key.shiftedIndex && itemstack.getItemDamage() == 2 && l == 4)
        {
            entityplayer.inventory.decrStackSize(entityplayer.inventory.currentItem, 1);
            world.setBlockMetadata(i, j, k, l + 1);
            world.setBlockTileEntity(i, j, k, tileentitychest);
