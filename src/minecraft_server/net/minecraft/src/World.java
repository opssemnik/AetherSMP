    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        {
        	System.out.println("VSFFF1");
            worldProvider = WorldProvider.func_4091_a(-1);
        }
        else  if(worldInfo != null && worldInfo.getDimension() == 3)
        {
        	System.out.println("VSFFF");
            worldProvider = WorldProvider.func_4091_a(3);
        }
        else
        {
        	System.out.println("VSFFF2");
