...
public class ItemSwordElemental extends ItemSword
{
    ...
    public boolean hitEntity(ItemStack itemstack, EntityLiving entityliving, EntityLiving entityliving1)
    {
        ...
        {
        	entityliving.worldObj.entityJoinedWorld(new EntityAetherLightning(entityliving.worldObj, (int)entityliving.posX, (int)entityliving.posY, (int)entityliving.posZ));
        }
