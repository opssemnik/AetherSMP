...
public class BlockIncubator extends BlockContainer
{
    ...
    protected BlockIncubator(int i)
    {
        ...
        blockIndexInTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/IncubatorTop.png");
        sideTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/IncubatorSide.png");
