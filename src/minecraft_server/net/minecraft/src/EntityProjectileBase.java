...
//            World, Vec3D, MovingObjectPosition, AxisAlignedBB, 
//            NBTTagCompound, ItemStack, InventoryPlayer
...
public abstract class EntityProjectileBase extends Entity
{
    ...
    {
        return entity.canBeCollidedWith() && (entity != shooter || ticksFlying >= 5) && (!(entity instanceof EntityLiving) || ((EntityLiving)entity).deathTime <= 0);
    }
