...
//            EntityFlying, IAetherBoss, NameGen, NBTTagCompound, 
//            mod_Aether, EntityLiving, Entity, World, 
//            AxisAlignedBB, EntityCreature, EntityPlayer, AetherBlocks, 
//            Block, ItemStack, AetherItems, MathHelper, 
//            BlockGrass, ModLoader, GuiIngame, Tool, 
//            AetherAchievements, EffectRenderer, GameSettings
     ...
     //   }
        ...
        if(flag)
        {
            ...
            if(health <= 0)
            {
                ...
                entityplayer.func_27017_a(AetherAchievements.defeatBronze);
                mod_Aether.currentBoss = null;
            } else
            if(!awake)
            {
