...
//            World, ChunkCoordinates, WorldProvider, PlayerAPI, 
//            WorldServer, Container, InventoryPlayer, EntityArrow, 
//            Material, Item, NetServerHandler, ItemMapBase, 
...
//            Packet22Collect, EntityTracker, Packet18Animation, Packet39AttachEntity, 
//            Packet100OpenWindow, ContainerWorkbench, IInventory, ContainerChest, 
...
//            Packet101CloseWindow, StatBase, Packet200Statistic, StringTranslate, 
//            Packet3Chat, EnumStatus, Packet17Sleep, Packet5PlayerInventory, 
//            Block, NBTTagCompound
    ...
    implements ICrafting
{
    ...
    public EntityPlayerMP(MinecraftServer minecraftserver, World world, String s, ItemInWorldManager iteminworldmanager)
    {
        ...
        username = s;
        yOffset = 0.0F;
        playerBases = PlayerAPI.playerInit(this);
    }
    ...
    {
        return PlayerAPI.isInWater(this, inWater);
    }
    ...
    {
        if(PlayerAPI.attackEntityFrom(this, entity, i))
        {
            return false;
        }
        if(ticksOfInvuln > 0)
    ...
    {
        if(PlayerAPI.onUpdateEntity(this, flag))
        {
            return;
        }
        super.onUpdate();
    ...
    public EnumStatus sleep(int i, int j, int k)
    {
    ...
    {
        return super.goToSleep(i, j, k);
    }

    public MinecraftServer getMc()
    {
        return mcServer;
    }
