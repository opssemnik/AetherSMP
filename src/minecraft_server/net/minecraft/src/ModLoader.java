...
public final class ModLoader
{
    ...
    private static void init()
    {
        ...
        try
        {
            ...
            logger.fine("ModLoader Server Beta 1.6.6v4 Initializing...");
            System.out.println("ModLoader Server Beta 1.6.6v4 Initializing...");
            MinecraftServer.logger.info("ModLoader Server Beta 1.6.6v4 Initializing...");
    ...
    private static void initStats()
    {
        ...
        {
            if(!StatList.field_25104_C.containsKey(Integer.valueOf(0x1000000 + i)) && Block.blocksList[i] != null && Block.blocksList[i].getEnableStats())
            {
                String s = StatCollector.translateToLocalFormatted("stat.mineBlock", new Object[] {
                    Block.blocksList[i].getNameLocalizedForStats()
                });
                StatList.mineBlockStatArray[i] = (new StatCrafting(0x1000000 + i, s, i)).func_27053_d();
                StatList.field_25120_d.add(StatList.mineBlockStatArray[i]);
            }
        }

        for(int j = 0; j < Item.itemsList.length; j++)
        {
            if(!StatList.field_25104_C.containsKey(Integer.valueOf(0x1020000 + j)) && Item.itemsList[j] != null)
            {
                String s1 = StatCollector.translateToLocalFormatted("stat.useItem", new Object[] {
                    Item.itemsList[j].func_25006_i()
                });
                StatList.field_25107_A[j] = (new StatCrafting(0x1020000 + j, s1, j)).func_27053_d();
                if(j >= Block.blocksList.length)
                {
                    StatList.field_25121_c.add(StatList.field_25107_A[j]);
                }
            }
            if(!StatList.field_25104_C.containsKey(Integer.valueOf(0x1030000 + j)) && Item.itemsList[j] != null && Item.itemsList[j].func_25005_e())
            {
                String s2 = StatCollector.translateToLocalFormatted("stat.breakItem", new Object[] {
                    Item.itemsList[j].func_25006_i()
                });
                StatList.field_25105_B[j] = (new StatCrafting(0x1030000 + j, s2, j)).func_27053_d();
            }
        }

        HashSet hashset = new HashSet();
        Object obj;
        for(Iterator iterator = CraftingManager.getInstance().getRecipeList().iterator(); iterator.hasNext(); hashset.add(Integer.valueOf(((IRecipe)obj).func_25077_b().itemID)))
        {
            obj = iterator.next();
        }
        ...
        do
        {
            ...
            if(!StatList.field_25104_C.containsKey(Integer.valueOf(0x1010000 + k)) && Item.itemsList[k] != null)
            {
                String s3 = StatCollector.translateToLocalFormatted("stat.craftItem", new Object[] {
                    Item.itemsList[k].func_25006_i()
                });
                StatList.field_25093_z[k] = (new StatCrafting(0x1010000 + k, s3, k)).func_27053_d();
            }
        } while(true);
    }
...
label0:
    ...
    public static void Init(MinecraftServer minecraftserver)
    {
        ...
        try
        {
            try
            {
                method_getNextWindowId = (net.minecraft.src.EntityPlayerMP.class).getDeclaredMethod("ai", (Class[])null);
            }
            catch(NoSuchMethodException nosuchmethodexception)
            {
            ...
            try
            {
                field_currentWindowId = (net.minecraft.src.EntityPlayerMP.class).getDeclaredField("bO");
            }
            catch(NoSuchFieldException nosuchfieldexception)
            {
    ...
    public static final String VERSION = "ModLoader Server Beta 1.6.6v4";
