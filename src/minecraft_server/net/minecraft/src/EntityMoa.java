...
public class EntityMoa extends EntityAetherAnimal
{
    ...
    public void onLivingUpdate()
    {
        ...
        if(!worldObj.singleplayerWorld && !baby && --timeUntilNextEgg <= 0)
        {
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        if(saddled && !worldObj.singleplayerWorld && (riddenByEntity == null || riddenByEntity == entityplayer))
        {
    ...
    {
        dropItem(Item.feather.shiftedIndex, 3 * ((this.playerToAttack != null && ((EntityPlayer)this.playerToAttack).inventory.getStackInSlot(0).itemID == AetherItems.SwordSkyroot.shiftedIndex ? 2 : 1)));
    }
