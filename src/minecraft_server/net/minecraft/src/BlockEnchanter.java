...
//            Block, TileEntityEnchanter, GuiEnchanter, EntityPlayer, 
...
public class BlockEnchanter extends BlockContainer
{
    ...
    protected BlockEnchanter(int i)
    {
        ...
        blockIndexInTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/EnchanterTop.png");
        sideTexture = ModLoader.addOverride("/terrain.png", "/aether/blocks/EnchanterSide.png");
